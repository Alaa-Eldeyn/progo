    ...
    <section className="relative overflow-hidden min-h-[700px] 2xl:min-h-[800px]">
      ...
      <div className="container">
        <div className="flex justify-between items-center min-h-[600px] 2xl:min-h-[700px]">
          <div className="flex flex-col md:text-start md:max-w-[500px] 2xl:max-w-[700px] md:w-1/2 text-3xl 2xl:text-[40px] leading-snug">
          ...
          <div className="hidden max-w-[700px] 2xl:w-[700px] md:w-[600px] md:block z-10">
